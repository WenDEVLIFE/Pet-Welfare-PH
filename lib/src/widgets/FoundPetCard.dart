...
class FoundPetCard extends StatefulWidget {
  ...
  @override
  State<FoundPetCard> createState() => _FoundPetCardState();
}

class _FoundPetCardState extends State<FoundPetCard>
                  ...
                  return [
                    if (isAdmin || isPostOwner)
                      PopupMenuItem(
                        ...
                        onTap: () {
                          // Use a post-frame callback to navigate after the menu closes.
                    ...
                    PopupMenuItem(
                      ...
                      onTap: () {
                        // Using a post-frame callback is safer for dialogs from menus.
                        WidgetsBinding.instance.addPostFrameCallback((_) {
                          showDialog(
                            context: context,
                            builder: (context) =>
                    ...
                    Visibility(
                      ...
                      child: PageView.builder(
                        ...
                        itemBuilder: (context, imageIndex) {
                          final imageUrl =
                              snapshot.data![imageIndex]; // Get the URL
                          print("Attempting to load image URL: $imageUrl");
                          ...
                          return GestureDetector(
                            ...
                            child: CachedNetworkImage(
                              ...
                              errorWidget: (context, url, error) {
                                print(
                                    "CachedNetworkImage Error for URL $url: $error"); // <<< MODIFY THIS
          ...
          ExpansionTile(
            ...
            children: [
              Padding(
                ...
                child: Column(
                  children: [
                    _buildDetailRow("Pet Name:", widget.post.petName),
                    _buildDetailRow("Pet Type:", widget.post.petType),
                    _buildDetailRow("Pet Breed:", widget.post.petBreed),
                    _buildDetailRow("Pet Gender:", widget.post.petGender),
                    _buildDetailRow("Pet Age:", widget.post.petAge),
                    _buildDetailRow("Pet Color:", widget.post.petColor),
                    if (widget.post.petType ==
                        'Others (for birds, reptiles, etc.)')
                      _buildDetailRow("Pet Collar:", widget.post.petCollar),
                    _buildDetailRow("Pet Size:", widget.post.petSize),
                    _buildDetailRow("Address:", widget.post.petAddress),
                    _buildDetailRow("Region/Province/City/Barangay:",
                        widget.post.regProCiBag),
                    _buildDetailRow("Status:", widget.post.Status),
                  ],
                ),
              ),
            ],

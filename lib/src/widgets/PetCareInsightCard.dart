          ...
          ExpansionTile(
            ...
            children: [
              Padding(
                ...
                child: Column(
                  children: [
                    _buildDetailRow("Clinic / Establishment Name:",
                        widget.post.establisHment_Clinic_Name),
                    _buildDetailRow("Address:", widget.post.establismentAdddress),
                    _buildDetailRow(
                      "Location:",
                      '${widget.post.establismentRegion}, ${widget.post.establismentProvinces}, ${widget.post.establismentCity}, ${widget.post.establismentBarangay}',
                    ),
                  ],
                ),
              ),
